...
\begin{frame}{Microscopy Data}{Volumes}
  \begin{itemize}
    \item Raw measured data from microscopes
    \item 3D scalar grids representing density values
    \item Isosurface levels are thresholds used to extract a 3D surface
  \end{itemize}
  \begin{figure}
    \centering
...
\begin{frame}{Microscopy Data}{Segmentations}
  \begin{itemize}
    \item Gives the raw volumetric data biological meaning
    \item Convert continuous density values into discrete objects
...
\begin{frame}{Visualization}{Mol* File Formats}
  \centering
  \small
  \begin{table}
    \begin{tabularx}{\textwidth}{@{} l X X @{}}
      \toprule
      & \textbf{CVSX} & \textbf{MVSX} \\
      \midrule
      \textbf{Ecosystem} & Deprecated Mol* VS & State-of-the-art Mol* \\
      \addlinespace
      \textbf{\makecell[l]{Feature\\Updates}} & No new features & Continuous new features \\
      \addlinespace
      \textbf{\makecell[l]{Volume\\Support}} & Yes & Yes \\
      \addlinespace
      \textbf{\makecell[l]{Segmentation\\Support}} & Yes & \makecell[l]{No, emulated via\\volumes and primitives} \\
      \bottomrule
    \end{tabularx}
  \end{table}
\end{frame}
...
\begin{frame}{Goals}
  \begin{alertblock}{\textbf{Thesis Objective}}
...
\section{Conversion Library}

\begin{frame}{Conversion Library --- Design}
  \begin{itemize}
    \item \textbf{Extract:} Read CVSX file contents
    \item \textbf{Transform:} Convert CVSX primitives to MVSX analogues
    \item \textbf{Load:} Serialize to MolViewSpec file formats
  \end{itemize}
  \begin{figure}
...
\begin{frame}{Conversion Library --- Results}
  ...
  \begin{itemize}
    ...
    \item Corrected author-defined isosurface levels
...
\begin{frame}{Conversion Library --- Improvements}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[height=0.5\textheight,keepaspectratio]{images/idr-6001240-cvsx.png}}
    \hspace{1cm}
    \subfigure[MVSX]{\includegraphics[height=0.5\textheight,keepaspectratio]{images/idr-6001240-mvsx.png}}
  \end{figure}  
  \textbf{Improvements:}
  \begin{itemize}
...
\begin{frame}{Conversion Library --- Improvements}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[height=0.5\textheight,keepaspectratio]{images/contour-missing.png}}
    \hspace{1cm}
    \subfigure[MVSX]{\includegraphics[height=0.5\textheight,keepaspectratio]{images/contour-present.png}}
  \end{figure}  
  \textbf{Improvements:}
  \begin{itemize}
    \item Fixed missing volumes, restored color annotations
    \item \alert{Corrected author-defined isosurface levels}
    \item Proper isosurface capping
  \end{itemize}
\end{frame}
...
\begin{frame}{Conversion Library --- Improvements}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[height=0.5\textheight,keepaspectratio]{images/missing-face-cvsx.png}}
    \hspace{1cm}
    \subfigure[MVSX]{\includegraphics[height=0.5\textheight,keepaspectratio]{images/missing-face-mvsx.png}}
  \end{figure}  
  \textbf{Improvements:}
  \begin{itemize}
    \item Fixed missing volumes, restored color annotations
...
\begin{frame}{Web Application}
  \begin{itemize}
    ...
    \item Interactively update biological annotations
    \item Sharing and export
  \end{itemize}
\end{frame}

\begin{frame}{Web Application --- Implementation}
  \textbf{\color{blue}Architecture}
  \begin{itemize}
  ...
  \end{itemize}
  \textbf{\color{blue}Infrastructure}
  \begin{itemize}
...
\begin{frame}{Conclusion}
  \begin{itemize}
    \item Replaced the Mol* VS with MolViewSpec
...
\begin{frame}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[height=0.4\textheight,keepaspectratio]{images/cvsx-slice.png}}
    \hspace{1cm}
    \subfigure[MVSX]{\includegraphics[height=0.4\textheight,keepaspectratio]{images/mvsx-slice.png}}
