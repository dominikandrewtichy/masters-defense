...
\begin{frame}{Mol*}{File Formats}
  \begin{columns}[t]
    \begin{column}{0.45\textwidth}
      \textbf{CVSX}
      \begin{itemize}
        \item Siloed to Mol* VS
        \item Limited to volumetric and segmentation data
        \item Fragmented files
      \end{itemize}
    \end{column}
    \begin{column}{0.45\textwidth}
      \textbf{MVSX}
      \begin{itemize}
        \item Viewer agnostic
        \item Extensible with structures
...
\begin{frame}{Mol*}{File Formats}
  ...
  \begin{table}
    \begin{tabularx}{\textwidth}{@{} l X X @{}}
      \toprule
      \textbf{Feature} & \textbf{CVSX} & \textbf{MVSX} \\
      \midrule
      \textbf{Ecosystem} & Siloed to Mol* VS & Viewer agnostic \\
      \addlinespace
      \textbf{Data Scope} & Volumes, segmentations only & Extensible (e.g., structures) \\
      \addlinespace
      \textbf{Structure} & Fragmented files & Single source of truth \\
      \addlinespace
      \textbf{AI} & Difficult to automate & LLM-friendly \\
      \bottomrule
    \end{tabularx}
  \end{table}
\end{frame}
