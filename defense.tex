...
\section[Data Mapping]{Data Mapping}
...
\begin{frame}{Mesh \& Geometric Segmentation}
  \begin{figure}
    \centering
    \includegraphics[height=0.85\textheight,keepaspectratio]{./images/segm-mapping-crop.pdf}
    % \caption{Mapping CVSX to MVSX}
  \end{figure}
\end{frame}
...
\begin{frame}{Conversion Library --- Improvements}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[width=0.4\textwidth]{images/idr-6001240-cvsx.png}}
    \subfigure[MVSX]{\includegraphics[width=0.4\textwidth]{images/idr-6001240-mvsx.png}}
...
\begin{frame}{Conversion Library --- Improvements}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[width=0.3\textwidth]{images/missing-face-cvsx.png}}
    \subfigure[MVSX]{\includegraphics[width=0.3\textwidth]{images/missing-face-mvsx.png}}
...
\begin{frame}{Conversion Library --- Improvements}
  \begin{figure}
    \centering
    \subfigure[CVSX]{\includegraphics[width=0.3\textwidth]{images/contour-missing.png}}
    \subfigure[MVSX]{\includegraphics[width=0.3\textwidth]{images/contour-present.png}}
...
\newenvironment{outroframe}{
  ...
  \begin{frame}[plain, environment=outroframe]
  \vfill
  \centering
}{
  \vfill
