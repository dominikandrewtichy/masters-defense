...
\begin{frame}{Conversion Library --- Implementation}{Lattice Segmentation}
  \begin{figure}
    \centering
    \includegraphics[height=0.8\textheight,keepaspectratio]{./images/lattice-mapping-crop.pdf}
    % \caption{Mapping CVSX to MVSX}
  \end{figure}
\end{frame}

\begin{frame}{Conversion Library --- Implementation}{Mesh \& Geometric Segmentation}
  \begin{figure}
    \centering
