...
\begin{frame}{Conversion Library}{Volumetric Data}
  \begin{figure}
    \centering
...
\begin{frame}{Conversion Library}{Lattice Segmentation}
  \begin{figure}
    \centering
...
\begin{frame}{Conversion Library}{Mesh \& Geometric Segmentation}
  \begin{figure}
    \centering
    \includegraphics[height=0.8\textheight,keepaspectratio]{./images/segm-mapping-crop.pdf}
    % \caption{Mapping CVSX to MVSX}
  \end{figure}
\end{frame}
...
\begin{frame}{Conversion Library --- Results}
  ...
  \begin{table}[htbp]
    ...
    \begin{tabular}{l r@{${}\times{}$}r@{${}\times{}$}l lrr}
      \toprule
      \textbf{Dataset ID} & \multicolumn{5}{c}{\textbf{Image dimensions (XYZ)}} & \textbf{Seg. type} & \textbf{Seg. count} & \textbf{Size (MB)} \\
      \midrule
...
\begin{frame}
  ...
  \end{block}
  \begin{itemize}
    \item Ano, stačí porovnat verze Mol* VS a upstream Mol*
  \end{itemize}
\end{frame}
